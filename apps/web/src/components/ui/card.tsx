...
// ── Card (Sovereign Careerist — no borders, tonal depth only) ──
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-xl bg-surface-container-highest shadow-ambient-sm surface-shift",
        className
      )}
      {...props}
    />
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("text-xl font-semibold leading-none text-on-surface font-display", className)} {...props} />
  )
);
...
// ── Glass Card (for floating notifications, modals) ──
